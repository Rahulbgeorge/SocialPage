...
import com.example.rahul.social_media.View.Helpers.SocialHelperHolders.BaseViewHolder
import com.example.rahul.social_media.View.Helpers.SocialHelperHolders.ImageHolder
import com.example.rahul.social_media.View.Helpers.SocialHelperHolders.ImageNTextHolder
import com.example.rahul.social_media.View.Helpers.SocialHelperHolders.TextHolder
...
class SocialRecyclerAdapter(var userData:ArrayList<Social>,val mcontext: Context, val newsItemListener: NewsItemListener ):RecyclerView.Adapter<BaseViewHolder>(){
    ...
    override fun onBindViewHolder(itemHolder: BaseViewHolder, position: Int) {
        ...
        if(socialData==null)
            ...
            itemHolder.shopButton.setOnClickListener({newsItemListener.callShopTrigger(socialData,position)})
            itemHolder.likeCount.text=socialData.likeCount.toString()
